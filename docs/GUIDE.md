...
> **Welcome to Product-Track Week 9, Task 5!**
...
| `src/build_runner.py` | Main source code - **has bugs to fix** |
| `src/ci_pipeline.yml` | Supporting code - **may also have bugs** |
| `tests/test_pipeline.py` | Test file - **add your tests here** |
...
### Incident - `src/build_runner.py`
**User Report / Alert:**
> "s are in the YAML config."
...
### Incident - `src/ci_pipeline.yml`
**User Report / Alert:**
> "by matching against the symptoms"
...
### Incident - `src/ci_pipeline.yml`
**User Report / Alert:**
> "needs 'install' but not 'build' — tests run before build"
...
### Incident - `src/ci_pipeline.yml`
**User Report / Alert:**
> "env vars from job-level don't auto-propagate to steps like this"
...
### Incident - `src/ci_pipeline.yml`
**User Report / Alert:**
> "Missing 'if: success()' — runs even if previous jobs fail"
